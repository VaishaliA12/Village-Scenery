...
int i;
float  tx = 10, bx = 10;
bool isDay = true; // Global variable to track day/night state
...
void display1() {
    ...
    //-----------------------------------field------------------------------
    glBegin(GL_POLYGON);
    glColor3ub(0, 100, 0);//green   //mountain = brown
    ...
    //-------------------------------------TREE------------------------
    glColor3ub(139, 69, 19); // side tree
    glRecti(-23, 200, -5, 140);
    glColor3ub(0, 100, 0);
    sun(-30, 190);
    sun(0, 190);
    sun(-10, 210);
